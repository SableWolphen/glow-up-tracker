...
-- enforces recipient scoping via owner_user_id/caregiver_user_id (see the policies
-- on support_notes/support_rewards/task_suggestions) — these are purely for
-- readability/compatibility with the sender_user_id/recipient_user_id naming used
-- elsewhere in the app's documentation.
